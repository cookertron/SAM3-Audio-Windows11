...
try:
    ...
    # Re-assigning for backward compatibility with original code structure
    ConstantClipsPerVideoSampler = data.ConstantClipsPerVideoSampler
    NormalizeVideo = data.NormalizeVideo
    SpatialCrop = data.SpatialCrop
    get_clip_timepoints = data.get_clip_timepoints
    load_and_transform_video_data = data.load_and_transform_video_data
    pv_transforms = data.pv_transforms
    transforms = data.transforms
    waveform2melspec = data.waveform2melspec
    imagebind_huge = imagebind_model.imagebind_huge
    ...
    NormalizeVideo = None
    SpatialCrop = None
    get_clip_timepoints = None
    load_and_transform_video_data = None
    pv_transforms = None
    transforms = None
    waveform2melspec = None
    imagebind_huge = None
    print("Warning: ImageBind dependency missing.")
